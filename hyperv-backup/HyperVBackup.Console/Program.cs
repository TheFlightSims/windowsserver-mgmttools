    ...
    class Program
    {
        ...
        private static void Main(string[] args)
        {
            ...
            try
            {
                ...
                System.Console.WriteLine("Hyper-V Backup");

                _logger.Info($"Hyper-V Backup started");

                if (!IsAdministrator())
                {
                    throw new Exception("Hyper-V Backup requires administrator permission!");
                }
        ...
        private static void CleanOutputByMegabytes(string output, int totalMb)
        {
            ...
            {
                _logger.Info($"Size of output folder is {totalSize / 1024 / 1024} MiB, deleting some files ...");
        ...
        static void Console_CancelKeyPress(object sender, ConsoleCancelEventArgs e)
        {
            ...
            System.Console.Error.WriteLine("Canceling backup operation...");
