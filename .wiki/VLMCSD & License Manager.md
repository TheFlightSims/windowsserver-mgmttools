...
Check the list of [product keys](https://github.com/TheFlightSims/windowsserver-mgmttools/tree/master/vlmcsd-beta/database-config/tables/Product%20Keys.csv) that VLMCSD can activate
