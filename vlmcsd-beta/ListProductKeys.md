## Valid Microsoft applications that can be acitvated using vlmcsd
 ...
 To see all vaild product keys for Windows and Office, see [here](https://github.com/TheFlightSimulationsOfficial/windowsserver-mgmttools/vlmcsd-beta/), and the list of vaild keys, check [there](https://github.com/TheFlightSimulationsOfficial/vlmcsd-beta/blob/master/db/getkeysonline/table/List%20Vaild%20Keys.csv)
