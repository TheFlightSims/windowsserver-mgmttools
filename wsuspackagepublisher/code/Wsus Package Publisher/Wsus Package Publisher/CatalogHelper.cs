...
{
    internal class CatalogHelper : CatalogHelperBase
    {
        ...
        internal UnpackArchiveFinishedEventHandler UnpackArchiveFinished;
        ...
        /// <summary>
        /// Expand the %temp% Environment Variable and add a random folder name (Guid) at the end.
        ...
        private bool ExtractCabToFolder(string cabFileToExtract, string destinationFolder)
        {
            ...
            try
            {
                ...
                Logger.Write("CAB extraction is being under development. If you still want to see what inside the Cab file, open it in the file explorer, or any compressed file viewer.");
