...
namespace Wsus_Package_Publisher
{
    internal partial class FrmPrerequisiteSubscribers : Form
    {
        ...
        public FrmPrerequisiteSubscribers(DataGridViewTextBoxColumn productName)
        {
        ...
        internal FrmPrerequisiteSubscribers(IUpdate updateToDelete, DataGridViewTextBoxColumn productName = null, DataGridViewTextBoxColumn update = null)
        {
